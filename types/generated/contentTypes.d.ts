...
export interface ApiAsianTourAsianTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Asian-Tour';
    pluralName: 'asian-tours';
    singularName: 'asian-tour';
  };
  options: {
...
export interface ApiHotelsHotels extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hotels.hotels'>;
...
export interface ApiReviewsReviews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ReviewMedias: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    VisitedDate: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
